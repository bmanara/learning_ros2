...
class FibonacciActionClient(Node):
    ...
    def get_result_callback(self, future):
        ...
        self.get_logger().info('Result received: {}'.format(result.sequence))
        rclpy.shutdown()
    
    def feedback_callback(self, feedback_msg):
        feedback = feedback_msg.feedback
        self.get_logger().info('Feedback received: {}'.format(feedback.partial_sequence))
...
def main(args=None):
    ...
    index = sys.argv[1] 
    fibonacci_action_client.send_goal(int(index))
